...
typedef void (*fieldProcessor_f)(uint8_t index, PGM_STR fieldName, void *pField, uint8_t vType, int16_t vMin, int16_t vMax);
...
#define FIELD_UINT8(data, type, vmin, vmax) { &(data), updater_uint8, inplace_updater_uint8, setter_uint8, processor_uint8, type, vmin, vmax }
#define FIELD_INT8(data, type, vmin, vmax) { &(data), updater_int8, inplace_updater_int8, setter_int8, processor_int8, type, vmin, vmax }
#define FIELD_INT16(data, type, vmin, vmax) { &(data), updater_int16, inplace_updater_int16, setter_int16, processor_int16, type, vmin, vmax }
#define FIELD_UINT16(data, type, vmin, vmax) { &(data), updater_uint16, inplace_updater_uint16, setter_uint16, processor_uint16, type, vmin, vmax }
#define FIELD_BOOL(func, toggle) { (void *)(func), updater_bool, inplace_updater_bool, NULL, (fieldProcessor_f)(toggle), 0xff, 0, 1 }
#define FIELD_PERCENT(data) { &(data), updater_percent, inplace_updater_percent, setter_percent, processor_percent, FIELD_TYPE_1_5_10, 0, 100 }
...
extern const char retractOpt[] PROGMEM;
...
extern void processor_int8(uint8_t index, PGM_STR fieldName, void *pField, uint8_t vType, int16_t vMin, int16_t vMax);
extern void processor_uint8(uint8_t index, PGM_STR fieldName, void *pField, uint8_t vType, int16_t vMin, int16_t vMax);
extern void processor_uint16(uint8_t index, PGM_STR fieldName, void *pField, uint8_t vType, int16_t vMin, int16_t vMax);
extern void processor_int16(uint8_t index, PGM_STR fieldName, void *pField, uint8_t vType, int16_t vMin, int16_t vMax);
extern void processor_percent(uint8_t index, PGM_STR fieldName, void *pField, uint8_t vType, int16_t vMin, int16_t vMax);
